...
|---|---|---|---|---|
| `/` | cabeçalho, radar, hero, cards, vídeo, temas, anúncio, newsletter, rodapé | vazio/API/sem campanha | ?/?/?/? | A R I parcial |
...
| `/painel/entrar` | login, campos, aviso | envio/erro/sessão ativa | V/V/V/V (normal) | A R I V parcial |
