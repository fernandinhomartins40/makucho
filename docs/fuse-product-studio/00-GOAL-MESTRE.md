...
- Produção após `011607b`: workflow de build/deploy concluído; home e login capturados em 390/820/1280/1440 px. A validação detectou overflow horizontal na home em 1280/1440 px por menu completo e imagem editorial de destaque que é um placeholder azul. Breakpoint do menu corrigido localmente para <1600 px; publicação e reteste dessa correção ainda necessários. Registros de mídia não foram alterados.
