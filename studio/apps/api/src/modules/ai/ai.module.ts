...
// custo. Fase 5b: selecao de trechos e risco semantico.
//
...
@Module({
  ...
  controllers: [AiController, AnaliseController],
  providers: [AiService, AnaliseService, UsoDeIaService, PromptsService, CryptoService],
