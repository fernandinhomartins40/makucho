...
- abertura e encerramento: roteiro para montar num editor de vídeo (CapCut,
  Canva, Premiere). `passos`: 5 a 8 passos em português, concretos: formato
  1080x1920, duração, fundo (cor hex), qual logo e onde (use `logo`:
  LOGO, LOGO_NEGATIVE ou LOGO_COMPACT), animação com tempos em segundos,
  texto (fonte e cor), som, e o último passo: exportar em MP4 1080x1920 e
  enviar em Biblioteca › Aberturas (ou Encerramentos). Abertura de 1,5 a
  3 s (curta: ninguém espera), encerramento de 2 a 4 s com chamada. `som`:
  prompt em inglês para o Suno.
